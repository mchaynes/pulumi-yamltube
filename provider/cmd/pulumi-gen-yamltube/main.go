...
import (
	...
	providerVersion "github.com/mchaynes/pulumi-yamltube/provider/pkg/version"
...
// BaseDir is the path to the base pulumi-yamltube directory.
var BaseDir string
...
func main() {
	flag.Usage = func() {
		const usageFormat = "Usage: %s <language> <swagger-or-schema-file> <root-pulumi-yamltube-dir>"
