...
namespace Pulumi.Yamltube
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Yamltube.version.txt");
    ...
    internal sealed class YamltubeResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public YamltubeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
